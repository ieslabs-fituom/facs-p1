...
exports.stu_view = function _callee6(req, res) {
...
exports.stu_get_filtered = function _callee7(req, res) {
...
exports.stu_get_profile = function _callee8(req, res) {
    ...
    while (1) {
      switch (_context9.prev = _context9.next) {
        ...
        case 53:
          ...
          console.log('Error : ' + _context9.t3);
        ...
        case 65:
          _context9.prev = 65;
          _context9.t4 = _context9["catch"](58);
        ...
        case 77:
          _context9.prev = 77;
          _context9.t5 = _context9["catch"](70);
          console.log('Error : ' + _context9.t5);
        ...
        case 89:
          _context9.prev = 89;
          _context9.t6 = _context9["catch"](82);
          console.log('Error : ' + _context9.t6);
        ...
        case 92:
          ...
          attendanceLoop = function attendanceLoop(_) {
            return regeneratorRuntime.async(function attendanceLoop$(_context8) {
              while (1) {
                switch (_context8.prev = _context8.next) {
                  case 0:
                    _context8.t0 = regeneratorRuntime.keys(groups);
...
exports.past_reports_view = function _callee9(req, res) {
  ...
  return regeneratorRuntime.async(function _callee9$(_context10) {
    while (1) {
      switch (_context10.prev = _context10.next) {
        ...
        case 31:
          _context10.prev = 31;
          _context10.t2 = _context10["catch"](24);
...
exports.past_get_groups = function _callee10(req, res) {
  ...
  return regeneratorRuntime.async(function _callee11$(_context12) {
    while (1) {
      switch (_context12.prev = _context12.next) {
        ...
        case 43:
          _context12.prev = 43;
          _context12.t2 = _context12["catch"](37);
...
exports.past_moduleattendance_view = function _callee13(req, res) {
...
exports.past_moduleattendance = function _callee14(req, res) {
  ...
  return regeneratorRuntime.async(function _callee14$(_context16) {
    while (1) {
      switch (_context16.prev = _context16.next) {
        ...
        case 5:
          matchingGroups = _context16.sent;
        ...
        case 13:
          getAttendance = function getAttendance(group) {
            return regeneratorRuntime.async(function getAttendance$(_context15) {
              while (1) {
        ...
        case 26:
          current_group_attendance = _context16.sent;
        ...
        case 67:
          _context16.prev = 67;
          _context16.t3 = _context16["catch"](63);
...
exports.timetable_view = function _callee15(req, res) {
...
exports.timetable_getlectures = function _callee16(req, res) {
  ...
  return regeneratorRuntime.async(function _callee16$(_context18) {
    while (1) {
      switch (_context18.prev = _context18.next) {
        ...
        case 51:
          _context18.prev = 51;
          _context18.t2 = _context18["catch"](43);
        ...
        case 69:
          _context18.prev = 69;
          _context18.t3 = _context18["catch"](61);
          console.log('Error : ' + _context18.t3);
          res.send({
            status: '500',
            lectures: []
          });
        ...
        case 86:
          _context18.prev = 86;
          _context18.t4 = _context18["catch"](78);
          console.log('Error : ' + _context18.t4);
          res.send({
            status: '500',
            lectures: []
          });
...
function load_attendance_of_a_student(groups) {
  var attendances, row;
  return regeneratorRuntime.async(function load_attendance_of_a_student$(_context20) {
    while (1) {
      switch (_context20.prev = _context20.next) {
        case 0:
          attendances = [];
          row = [];
          groups.forEach(function _callee17(element) {
...
function loadInitialDetails() {
  ...
  return regeneratorRuntime.async(function loadInitialDetails$(_context21) {
    while (1) {
      switch (_context21.prev = _context21.next) {
        ...
        case 19:
          ...
          return _context21.abrupt("return", employee_details);
