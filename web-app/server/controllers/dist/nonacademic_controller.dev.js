...
exports.stu_view = function _callee10(req, res) {
...
exports.stu_get_filtered = function _callee11(req, res) {
...
exports.stu_get_profile = function _callee12(req, res) {
  ...
  return regeneratorRuntime.async(function _callee12$(_context13) {
    while (1) {
      switch (_context13.prev = _context13.next) {
        ...
        case 65:
          _context13.prev = 65;
          _context13.t4 = _context13["catch"](58);
        ...
        case 77:
          _context13.prev = 77;
          _context13.t5 = _context13["catch"](70);
          console.log('Error : ' + _context13.t5);
        ...
        case 89:
          _context13.prev = 89;
          _context13.t6 = _context13["catch"](82);
          console.log('Error : ' + _context13.t6);
        ...
        case 92:
          ...
          attendanceLoop = function attendanceLoop(_) {
            return regeneratorRuntime.async(function attendanceLoop$(_context12) {
              while (1) {
                switch (_context12.prev = _context12.next) {
                  case 0:
                    _context12.t0 = regeneratorRuntime.keys(groups);
...
exports.past_reports_view = function _callee13(req, res) {
  ...
  return regeneratorRuntime.async(function _callee13$(_context14) {
    while (1) {
      switch (_context14.prev = _context14.next) {
        ...
        case 3:
          employee_details = _context14.sent;
          _context14.prev = 4;
          _context14.next = 7;
          return regeneratorRuntime.awrap(commonFunctions.getBatchDetails(conn, null));

        case 7:
          batches = _context14.sent;
          console.log(batches);
          _context14.next = 14;
          break;
        ...
        case 21:
          ...
          console.log('Error : ' + _context14.t1);
        ...
        case 31:
          _context14.prev = 31;
          _context14.t2 = _context14["catch"](24);
...
exports.past_get_groups = function _callee14(req, res) {
...
exports.past_get_sessions = function _callee15(req, res) {
  var group, groups, sessions, lecturers, lec_id, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, _session2;
    ...
    while (1) {
      switch (_context16.prev = _context16.next) {
        ...
        case 16:
          ...
          for (_iterator2 = sessions[Symbol.iterator](); !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            _session2 = _step2.value;
        ...
        case 43:
          ...
          console.log('Error : ' + _context16.t2);
          res.send({
            status: '500',
            sessions: sessions,
            lecturers: lecturers
...
exports.past_get_sessionattendance = function _callee16(req, res) {
    ...
    while (1) {
      switch (_context17.prev = _context17.next) {
        ...
        case 29:
          ...
          console.log('Error : ' + _context17.t1);
          res.send({
            status: '500',
            attendance: []
          });
        ...
        case 46:
          ...
          console.log('Error : ' + _context17.t2);
          res.send({
            status: '500',
            attendance: []
          });
...
exports.past_moduleattendance_view = function _callee17(req, res) {
...
exports.past_moduleattendance = function _callee18(req, res) {
  var module, batch, matchingGroups, getAttendance, attendance_of_groups, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, _group, current_group_attendance, present, session_count, percentage, finalAttendance, studentAttendance, _i, _attendance_of_groups, _group2, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, _student, key;
      ...
      switch (_context20.prev = _context20.next) {
        ...
        case 13:
          getAttendance = function getAttendance(group) {
            return regeneratorRuntime.async(function getAttendance$(_context19) {
              while (1) {
          ...
          _context20.prev = 18;
          _iterator3 = matchingGroups[Symbol.iterator]();
        ...
        case 26:
          current_group_attendance = _context20.sent;
        ...
        case 30:
          ...
          console.log('Error : ' + _context20.t1);
          res.send({
            status: '500'
          });
          return _context20.abrupt("return");
        ...
        case 40:
          _context20.prev = 40;
          _context20.t2 = _context20["catch"](18);
        ...
        case 55:
          ...
          for (_iterator4 = _group2[Symbol.iterator](); !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
            _student = _step4.value;
            studentAttendance = [];
            present = 0;
            session_count = 0;
        ...
        case 67:
          _context20.prev = 67;
          _context20.t3 = _context20["catch"](63);
        ...
        case 77:
          return _context20.finish(74);

        case 78:
          return _context20.finish(71);
...
exports.past_degreeattendance_view = function _callee19(req, res) {
...
exports.past_degreeattendance = function _callee20(req, res) {
  ...
  return regeneratorRuntime.async(function _callee20$(_context22) {
    while (1) {
      switch (_context22.prev = _context22.next) {
        ...
        case 6:
          matchingGroups = _context22.sent;
          console.log(matchingGroups);
          _context22.next = 14;
          break;
...
exports.timetable_view = function _callee21(req, res) {
  var employee_details, degrees, batches;
  return regeneratorRuntime.async(function _callee21$(_context23) {
    while (1) {
      switch (_context23.prev = _context23.next) {
        ...
        case 3:
          employee_details = _context23.sent;
          _context23.prev = 4;
          _context23.next = 7;
          return regeneratorRuntime.awrap(commonFunctions.getBatchDetails(conn, null));

        case 7:
          batches = _context23.sent;
          console.log(batches);
          _context23.next = 14;
          break;
        ...
        case 21:
          _context23.prev = 21;
          _context23.t1 = _context23["catch"](14);
          console.log('Error : ' + _context23.t1);
...
exports.timetable_getlectures = function _callee22(req, res) {
  ...
  return regeneratorRuntime.async(function _callee22$(_context24) {
    while (1) {
      switch (_context24.prev = _context24.next) {
        ...
        case 51:
          _context24.prev = 51;
          _context24.t2 = _context24["catch"](43);
        ...
        case 69:
          _context24.prev = 69;
          _context24.t3 = _context24["catch"](61);
        ...
        case 86:
          _context24.prev = 86;
          _context24.t4 = _context24["catch"](78);
...
function load_attendance_of_a_student(groups) {
  var attendances, row;
  return regeneratorRuntime.async(function load_attendance_of_a_student$(_context26) {
    while (1) {
      switch (_context26.prev = _context26.next) {
        case 0:
          attendances = [];
          row = [];
          groups.forEach(function _callee23(element) {
...
function loadInitialDetails() {
  ...
  return regeneratorRuntime.async(function loadInitialDetails$(_context27) {
    while (1) {
      switch (_context27.prev = _context27.next) {
        ...
        case 4:
          employee_details = _context27.sent;
          _context27.next = 10;
          break;
        ...
        case 16:
          ...
          console.log('Error : ' + _context27.t1);
        ...
        case 19:
          ...
          return _context27.abrupt("return", employee_details);
