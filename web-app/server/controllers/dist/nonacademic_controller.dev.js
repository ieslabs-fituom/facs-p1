...
exports.stu_view = function _callee9(req, res) {
  ...
  return regeneratorRuntime.async(function _callee9$(_context9) {
    while (1) {
      switch (_context9.prev = _context9.next) {
        ...
        case 32:
          _context9.prev = 32;
          _context9.t2 = _context9["catch"](25);
          console.log('Error : ' + _context9.t2);
...
exports.stu_get_filtered = function _callee10(req, res) {
...
exports.stu_get_profile = function _callee11(req, res) {
  ...
  return regeneratorRuntime.async(function _callee11$(_context12) {
    while (1) {
      switch (_context12.prev = _context12.next) {
        ...
        case 42:
          _context12.prev = 42;
          _context12.t2 = _context12["catch"](35);
        ...
        case 77:
          _context12.prev = 77;
          _context12.t5 = _context12["catch"](70);
          console.log('Error : ' + _context12.t5);
        ...
        case 89:
          _context12.prev = 89;
          _context12.t6 = _context12["catch"](82);
          console.log('Error : ' + _context12.t6);
        ...
        case 92:
          ...
          attendanceLoop = function attendanceLoop(_) {
            return regeneratorRuntime.async(function attendanceLoop$(_context11) {
              while (1) {
                switch (_context11.prev = _context11.next) {
                  case 0:
                    _context11.t0 = regeneratorRuntime.keys(groups);
...
exports.past_reports_view = function _callee12(req, res) {
  ...
  return regeneratorRuntime.async(function _callee12$(_context13) {
    while (1) {
      switch (_context13.prev = _context13.next) {
        ...
        case 31:
          _context13.prev = 31;
          _context13.t2 = _context13["catch"](24);
...
exports.past_get_groups = function _callee13(req, res) {
...
exports.past_get_sessions = function _callee14(req, res) {
...
exports.past_get_sessionattendance = function _callee15(req, res) {
  ...
  return regeneratorRuntime.async(function _callee15$(_context16) {
    while (1) {
      switch (_context16.prev = _context16.next) {
        ...
        case 29:
          _context16.prev = 29;
          _context16.t1 = _context16["catch"](22);
        ...
        case 46:
          _context16.prev = 46;
          _context16.t2 = _context16["catch"](39);
...
exports.past_moduleattendance_view = function _callee16(req, res) {
  ...
  return regeneratorRuntime.async(function _callee16$(_context17) {
    while (1) {
      switch (_context17.prev = _context17.next) {
        ...
        case 3:
          employee_details = _context17.sent;
          _context17.prev = 4;
          _context17.next = 7;
          return regeneratorRuntime.awrap(commonFunctions.getBatchDetails(conn, null));

        case 7:
          batches = _context17.sent;
          console.log(batches);
          _context17.next = 14;
          break;
...
exports.past_moduleattendance = function _callee17(req, res) {
  ...
  return regeneratorRuntime.async(function _callee17$(_context19) {
    while (1) {
      switch (_context19.prev = _context19.next) {
        ...
        case 5:
          matchingGroups = _context19.sent;
        ...
        case 13:
          getAttendance = function getAttendance(group) {
            return regeneratorRuntime.async(function getAttendance$(_context18) {
              while (1) {
        ...
        case 26:
          current_group_attendance = _context19.sent;
        ...
        case 40:
          _context19.prev = 40;
          _context19.t2 = _context19["catch"](18);
        ...
        case 67:
          _context19.prev = 67;
          _context19.t3 = _context19["catch"](63);
...
exports.past_degreeattendance_view = function _callee18(req, res) {
  ...
  return regeneratorRuntime.async(function _callee18$(_context20) {
    while (1) {
      switch (_context20.prev = _context20.next) {
        ...
        case 3:
          employee_details = _context20.sent;
          _context20.prev = 4;
          _context20.next = 7;
          return regeneratorRuntime.awrap(commonFunctions.getBatchDetails(conn, null));

        case 7:
          batches = _context20.sent;
          console.log(batches);
          _context20.next = 14;
          break;
...
exports.past_degreeattendance = function _callee19(req, res) {
  ...
  return regeneratorRuntime.async(function _callee19$(_context21) {
    while (1) {
      switch (_context21.prev = _context21.next) {
        ...
        case 6:
          matchingGroups = _context21.sent;
          console.log(matchingGroups);
          _context21.next = 14;
          break;
...
exports.timetable_view = function _callee20(req, res) {
  var employee_details, degrees, batches;
...
exports.timetable_getlectures = function _callee21(req, res) {
  ...
  return regeneratorRuntime.async(function _callee21$(_context23) {
    while (1) {
      switch (_context23.prev = _context23.next) {
        ...
        case 51:
          _context23.prev = 51;
          _context23.t2 = _context23["catch"](43);
        ...
        case 69:
          ...
          console.log('Error : ' + _context23.t3);
          res.send({
            status: '500',
            lectures: []
          });
        ...
        case 86:
          _context23.prev = 86;
          _context23.t4 = _context23["catch"](78);
          console.log('Error : ' + _context23.t4);
          res.send({
            status: '500',
            lectures: []
          });
...
function load_attendance_of_a_student(groups) {
  var attendances, row;
  return regeneratorRuntime.async(function load_attendance_of_a_student$(_context25) {
    while (1) {
      switch (_context25.prev = _context25.next) {
        case 0:
          attendances = [];
          row = [];
          groups.forEach(function _callee22(element) {
...
function loadInitialDetails() {
  ...
  return regeneratorRuntime.async(function loadInitialDetails$(_context26) {
    while (1) {
      switch (_context26.prev = _context26.next) {
        ...
        case 19:
          ...
          return _context26.abrupt("return", employee_details);
